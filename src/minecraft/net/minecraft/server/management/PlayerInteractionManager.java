...
public class PlayerInteractionManager
{
    ...
    public boolean tryHarvestBlock(BlockPos pos)
    {
        ...
        if (autoTool.getState()&&autoTool.getSilentValue().get()&&autoTool.getNowSlot()!=this.player.inventory.currentItem){
            heldItem = this.player.inventory.getStackInSlot(autoTool.getNowSlot());
        }

        if (this.gameType.isCreative() && !/**this.player.getHeldItemMainhand()**/heldItem.isEmpty() && /**this.player.getHeldItemMainhand()**/heldItem.getItem() instanceof ItemSword)
        {
            return false;
        }
        else
