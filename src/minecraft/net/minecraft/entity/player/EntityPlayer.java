...
import kevin.event.PlayerTravelEvent;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public float getDigSpeed(IBlockState state)
    {
        ...
        if (autoTool.getState()&&autoTool.getSilentValue().get()&&autoTool.getNowSlot()!= Minecraft.getMinecraft().player.inventory.currentItem){
            f = this.inventory.getStackInSlot(autoTool.getNowSlot()).getStrVsBlock(state);
        }
