...
public class EnchantmentHelper
{
    ...
    public static void applyThornEnchantments(EntityLivingBase p_151384_0_, Entity p_151384_1_)
    {
        ...
        {
            ItemStack heldItem = p_151384_0_.getHeldItemMainhand();
            AutoTool autoTool = (AutoTool) KevinClient.moduleManager.getModule("AutoTool");
            if (autoTool.getState()&&p_151384_0_== Minecraft.getMinecraft().player&&autoTool.getSilentValue().get()&&autoTool.getNowSlot()!=Minecraft.getMinecraft().player.inventory.currentItem) {
                heldItem = Minecraft.getMinecraft().player.inventory.getStackInSlot(autoTool.getNowSlot());
            }
            applyEnchantmentModifier(ENCHANTMENT_ITERATOR_HURT, heldItem/*p_151384_0_.getHeldItemMainhand()*/);
        }
    }
    ...
    public static void applyArthropodEnchantments(EntityLivingBase p_151385_0_, Entity p_151385_1_)
    {
        ...
        {
            ItemStack heldItem = p_151385_0_.getHeldItemMainhand();
            AutoTool autoTool = (AutoTool) KevinClient.moduleManager.getModule("AutoTool");
            if (autoTool.getState()&&p_151385_0_== Minecraft.getMinecraft().player&&autoTool.getSilentValue().get()&&autoTool.getNowSlot()!=Minecraft.getMinecraft().player.inventory.currentItem) {
                heldItem = Minecraft.getMinecraft().player.inventory.getStackInSlot(autoTool.getNowSlot());
            }
            applyEnchantmentModifier(ENCHANTMENT_ITERATOR_DAMAGE, heldItem/*p_151385_0_.getHeldItemMainhand()*/);
        }
    }
    ...
    public static int getMaxEnchantmentLevel(Enchantment p_185284_0_, EntityLivingBase p_185284_1_)
    {
        ...
        AutoTool autoTool = (AutoTool) KevinClient.moduleManager.getModule("AutoTool");
        if (autoTool.getState()&& p_185284_1_ == Minecraft.getMinecraft().player &&autoTool.getSilentValue().get()&&autoTool.getNowSlot()!=Minecraft.getMinecraft().player.inventory.currentItem){
            List<ItemStack> list = Lists.newArrayList();
            for (ItemStack itemStack : iterable){ list.add(itemStack); }
            list.add(Minecraft.getMinecraft().player.inventory.getStackInSlot(autoTool.getNowSlot()));
            iterable = list;
        }
