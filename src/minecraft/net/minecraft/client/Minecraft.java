...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(KevinClient.getClientName() + " " + KevinClient.getVersion() + " | Minecraft 1.12");
    ...
    private void sendClickBlockToController(boolean leftClick)
    {
        ...
        if (this.leftClickCounter <= 0 && (!this.player.isHandActive() || KevinClient.moduleManager.getModule("MultiActions").getState()))
        {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK)
            {
                ...
                if (this.leftClickCounter == 0 && blockState.getBlock().getMaterial(blockState) != Material.AIR) {
                    EventManager.INSTANCE.callEvent(new ClickBlockEvent(objectMouseOver.getBlockPos(), this.objectMouseOver.sideHit));
                }

                BlockPos blockpos = this.objectMouseOver.getBlockPos();

                if (this.leftClickCounter == 0)
                    EventManager.INSTANCE.callEvent(new ClickBlockEvent(blockpos, this.objectMouseOver.sideHit));
    ...
    public void runTick() throws IOException
    {
        ...
        EventManager.INSTANCE.callEvent(new PostTickEvent());
    }
    ...
    public void loadWorld(@Nullable WorldClient worldClientIn, String loadingMessage)
    {
        ...
        EventManager.INSTANCE.callEvent(new WorldEvent(worldClientIn));
