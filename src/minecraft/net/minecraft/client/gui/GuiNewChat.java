...
import kevin.module.modules.misc.InfiniteChatLength;
import kevin.module.modules.misc.NoChatClear;
...
public class GuiNewChat extends Gui
{
    ...
    public void clearChatMessages(boolean p_146231_1_)
    {
        if (!KevinClient.INSTANCE.isStarting()) {
            Module noChatClear = KevinClient.moduleManager.getModule("NoChatClear");
            if (noChatClear != null && noChatClear.getState()) {
                this.printChatMessage(new TextComponentString("§l§7[§l§9" + KevinClient.getClientName() + "§l§7] §cClear Chat!"));
                return;
            }
        }
    ...
    private void setChatLine(ITextComponent chatComponent, int chatLineId, int updateCounter, boolean displayOnly)
    {
        ...
        final boolean infiniteChat = KevinClient.moduleManager.getModule(InfiniteChatLength.class).getState();

        if (!infiniteChat) while (this.drawnChatLines.size() > 100)
        {
        ...
        if (!displayOnly)
        {
            ...
            if (!infiniteChat) while (this.chatLines.size() > 100)
            {
