...
public class CPacketUseEntity implements Packet<INetHandlerPlayServer>
{
    ...
    public CPacketUseEntity(Entity entityIn,Action action, EnumHand handIn, Vec3d hitVecIn)
    {
        this.entityId = entityIn.getEntityId();
        this.action = action;
        this.hand = handIn;
    ...
    public CPacketUseEntity(Entity entityIn,Action action, EnumHand handIn)
    {
        this.entityId = entityIn.getEntityId();
        this.action = action;
        this.hand = handIn;
