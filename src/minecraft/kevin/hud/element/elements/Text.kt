...
class Text(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F,
    ...
    companion object {
        ...
        fun defaultClientVersion(): Text {
            val text = Text((FontManager.font40.getStringWidth(KevinClient.clientName) + 1)/0.6,(11F)/0.6, scale = 0.6F)
    ...
    private var fontValue = FontManager.font35
    ...
    private fun getReplacement(str: String): String? {
        ...
        return when (str.toLowerCase()) {
            ...
            "clientname" -> KevinClient.clientName
