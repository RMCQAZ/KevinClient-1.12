...
class Notification(private val message: String) {
    ...
    init {
        stayTimer.reset()
        firstY = 1919F
        textLength = FontManager.font35.getStringWidth(message)
    }
    ...
    fun drawNotification(animationY: Float) {
        ...
        if (message.contains("Enabled")) {
            ...
            FontManager.font35.drawString(message, -x + 4, -14F-y, Color(0, 255, 160).rgb)
            ...
            FontManager.font35.drawString(message, -x + 4, -14F-y, Color(255, 0, 80).rgb)
        }else {
            ...
            FontManager.font35.drawString(message, -x + 4, -14F-y, Color(0, 160, 255).rgb)
        }
    ...
    fun drawNotificationKevinNew(animationY: Float,text2:String = "") {
        ...
        FontManager.font35.drawString(message, -x + (8F + textLength)/2 - FontManager.font35.getStringWidth(message)/2, -14F-y, color)
        FontManager.font35.drawString(text, -x + (8F + textLength)/2 - FontManager.font35.getStringWidth(text)/2, -30F-y, color)
        GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f)
