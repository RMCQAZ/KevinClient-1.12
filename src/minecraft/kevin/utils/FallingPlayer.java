...
public class FallingPlayer extends Mc {
    ...
    private void calculateForTick() {
        ...
        if (v >= 0.0001f) {
            ...
            v = getMc().player.jumpMovementFactor / v;
            strafe = strafe * v;
            forward = forward * v;
    ...
    private BlockPos rayTrace(Vec3d start, Vec3d end) {
        RayTraceResult result = getMc().world.rayTraceBlocks(start, end, true);
